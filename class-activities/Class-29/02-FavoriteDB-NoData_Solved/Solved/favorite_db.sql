...
values('chicken parm',9),('beer',10),('pizza',8);




insert into favorite_songs
values ('shine on you crazy diamond','pink floyd',10),('too many puppies','primus',7),('40s theme','umphrey\'s mcgee',9);


insert into favorite_movies(movie,score,five_times)
values ('requiem for a dream',10,true),('american history x',9,true);
